...
const search = () => {
return (
    <form className="flex items-center max-w-lg mx-auto space-x-2 mt-10 w-full">   
    ...
    <div className="relative w-full">
        ...
        <input type="text" id="voice-search" className="block w-full border-1 border-[#eee] h-10  shadow-xs placeholder:text-body ps-10 rounded-2xl placeholder:text-white" placeholder="Search Mockups, Logos, Templates..." required />
    ...
    <button type="submit" className="inline-flex items-center  text-white theme-bg hover:bg-brand-strong theme-button box-border border border-transparent focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none">
